...
(function(vue) {
  ...
  const _imports_0$3 = "/static/setting.png";
  const _imports_1$1 = "/static/search.png";
  const _imports_1 = "/static/xiaoxin2.jpg";
  const _imports_0$2 = "/static/xxavatar1.jpg";
  const _imports_4 = "/static/爱心.svg";
  ...
  const UniDrawer = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$d], ["__scopeId", "data-v-183a7e94"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/node_modules/@dcloudio/uni-ui/lib/uni-drawer/uni-drawer.vue"]]);
  const _sfc_main$i = {
    __name: "Home",
    setup(__props) {
      ...
      function showDrawer() {
        showLeft.value.open();
        formatAppLog("log", "at pages/Home.vue:75", 111);
      }
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          vue.createElementVNode("view", { class: "layout-top" }, [
            vue.createElementVNode("view", { class: "box-top" }, [
              vue.createElementVNode("view", { class: "setting" }, [
                ...
                vue.createElementVNode("view", { class: "drawer-body" }, [
                  vue.createVNode(
                    UniDrawer,
                    {
                      ref_key: "showLeft",
              ...
              vue.createElementVNode("view", { class: "discover" }, [
                vue.createElementVNode("button", {
                  plain: "ture",
                  class: "btn"
                }, "发现")
              ...
              (vue.openBlock(), vue.createElementBlock(
                ...
                vue.renderList(20, (item) => {
                  return vue.createElementVNode("view", {
                    ...
                    vue.createElementVNode("view", { class: "text" }, "iPhone 16 Pro 上手：相机按钮怎么玩？屏幕大了吗"),
                    vue.createElementVNode("view", { class: "info" }, [
                      ...
                      vue.createElementVNode("text", { class: "nickname" }, "小新"),
                      vue.createElementVNode("view", { class: "likes" }, [
                        vue.createElementVNode("image", {
                          class: "like-icon",
                          src: _imports_4
                        }),
                        vue.createElementVNode("text", { class: "like-count" }, "120")
                      ])
                    ])
                  ]);
                }),
  ...
  const PagesHome = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-10483572"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/pages/Home.vue"]]);
  const _sfc_main$h = {
    name: "UniSection",
    emits: ["click"],
    props: {
  ...
  const UniSection = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$c], ["__scopeId", "data-v-17c33c2a"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/node_modules/@dcloudio/uni-ui/lib/uni-section/uni-section.vue"]]);
  const fontData = [
    {
  ...
  const uniIcons = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$b], ["__scopeId", "data-v-946bce22"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/node_modules/@dcloudio/uni-ui/lib/uni-icons/uni-icons.vue"]]);
  const _sfc_main$f = {
    name: "UniListItem",
  ...
  const UniListItem = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$a], ["__scopeId", "data-v-d88f6cd0"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/node_modules/@dcloudio/uni-ui/lib/uni-list-item/uni-list-item.vue"]]);
  const _sfc_main$e = {
    __name: "CatClaw",
    setup(__props) {
      const nowTime = vue.ref("");
      function getNowTimeDate() {
        ...
        updateTime();
        return setInterval(updateTime, 1e3);
      }
      let timer = null;
      vue.onMounted(() => {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          vue.createElementVNode("view", { class: "layout" }, [
            vue.createCommentVNode(" 展示卡片信息 "),
            vue.createElementVNode("view", { class: "showCardBox" }, [
              vue.createElementVNode("view", { class: "paw" }, [
                vue.createElementVNode("view", null, [
                  vue.createElementVNode("text", null, "爪子卡片")
                ])
              ]),
              vue.createCommentVNode(" 地区选择 "),
              vue.createElementVNode("view", { class: "area" }, [
                vue.createElementVNode("view", { class: "t4t33t" }, [
                  vue.createElementVNode("view", { class: "t34t3" }, " All "),
                  (vue.openBlock(), vue.createElementBlock(
                    vue.Fragment,
                    null,
                    vue.renderList(3, (item) => {
                      return vue.createElementVNode("view", { class: "t36fsf" }, [
                        vue.createElementVNode(
                          "view",
                          { class: "item" },
              ...
              vue.createCommentVNode(" 卡片循环区域 "),
              vue.createElementVNode("view", { class: "Cardlist" }, [
                vue.createElementVNode("scroll-view", {
                  class: "ta9u0a",
                  "scroll-x": "true"
                }, [
                  vue.createElementVNode("view", { class: "t42f" }, [
                    vue.createCommentVNode(" //每个卡片 "),
                    (vue.openBlock(), vue.createElementBlock(
                      vue.Fragment,
                      null,
                      vue.renderList(6, (i2) => {
                        return vue.createElementVNode("view", { class: "t2352" }, [
                          vue.createCommentVNode(" 图片 "),
                          vue.createElementVNode("view", { class: "t7908f" }, [
                            vue.createElementVNode("image", {
                              class: "img32r",
                              src: _imports_0$2,
                              mode: ""
                          ...
                          vue.createElementVNode("view", { class: "t990k" }, [
                            vue.createElementVNode("view", { class: "t5grg3" }, [
                              vue.createElementVNode("text", { class: "t2rdf" }, "白鹭岛门票+小火车门票+游湖船票+灯光秀门票+君鼎酒店 白鹭岛门票+小火车门票+游湖船票+灯光秀门票+君鼎酒店")
                            ])
                          ]),
                          vue.createCommentVNode(" 分割线 "),
                          vue.createElementVNode("view", { class: "divider" }),
                          vue.createCommentVNode(" 热度讨论分享 "),
                          vue.createElementVNode("view", { class: "t79h" }, [
                            vue.createElementVNode("view", { class: "" }, [
                              vue.createVNode(uniIcons, {
                                type: "fire",
                                size: "18"
                              }),
                              vue.createTextVNode(" 热度 ")
                            ]),
                            vue.createElementVNode("view", { class: "" }, [
                              vue.createVNode(uniIcons, {
                                type: "chatbubble",
            ...
            vue.createCommentVNode(" 展示统计信息 "),
            vue.createElementVNode("view", { class: "showStatisticsBox" }, [
              vue.createElementVNode("view", { class: "t8time" }, [
                vue.createElementVNode(
                  "text",
                  null,
                  "时间：" + vue.toDisplayString(nowTime.value),
                  1
                  /* TEXT */
                )
              ]),
              vue.createElementVNode("view", { class: "t78hg" }, [
                vue.createElementVNode("text", null, "历史小猫总数：80只，在校小猫数量：30只"),
                vue.createElementVNode("text", null, "已领养：x只"),
                vue.createElementVNode("text", null, "分布区域：xx,xx,xx,xx"),
                vue.createElementVNode("text"),
                vue.createElementVNode("text", null, "本月救助资金剩余：xxx元"),
                vue.createElementVNode("text", null, "上个月支出：xxx元"),
                vue.createElementVNode("text", null, "上个月收入：xxx元"),
                vue.createElementVNode("text", null, "累计资金：xxxx元"),
                vue.createElementVNode("text"),
                vue.createElementVNode("text", null, "校内爱猫人数：xxxx人，帖子总数：xxx个"),
                vue.createElementVNode("text")
              ])
            ]),
            vue.createCommentVNode(" 展示捐助领养区域 "),
            vue.createElementVNode("view", { class: "showDonateBox" }, [
              vue.createElementVNode("view", { class: "t89h" }, [
                vue.createElementVNode("button", null, "我要领养")
              ]),
              vue.createElementVNode("view", { class: "t233" }, [
                vue.createElementVNode("button", null, "我要捐赠")
              ])
            ])
          ])
        ]);
  ...
  const PagesCatClaw = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-7611d5f4"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/pages/CatClaw.vue"]]);
  const pages = [
    {
      path: "pages/Home",
      style: {
  ...
  const tabBar = {
    ...
    list: [
      ...
      {
        pagePath: "pages/CatClaw",
        iconPath: "static/paw.svg",
        selectedIconPath: "static/paw-active.svg"
      },
      {
        pagePath: "pages/Map",
        iconPath: "static/导航.png",
        selectedIconPath: "static/导航选中.png"
      },
      {
        pagePath: "pages/My",
        iconPath: "static/mine.svg",
        selectedIconPath: "static/mine-active.svg"
      }
    ]
  };
  const e = {
...
详细信息：${s4}`), r3(i3);
  ...
  const DataPickerView = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$9], ["__scopeId", "data-v-9bf6d4b8"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/node_modules/@dcloudio/uni-ui/lib/uni-data-pickerview/uni-data-pickerview.vue"]]);
  const _sfc_main$c = {
    name: "UniDataPicker",
  ...
  const UniDataPicker = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$8], ["__scopeId", "data-v-e10759db"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/node_modules/@dcloudio/uni-ui/lib/uni-data-picker/uni-data-picker.vue"]]);
  ...
  const uniRow = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$7], ["__scopeId", "data-v-86edfd37"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/node_modules/@dcloudio/uni-ui/lib/uni-row/uni-row.vue"]]);
  ...
  const uniCol = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$6], ["__scopeId", "data-v-6ad5e460"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/node_modules/@dcloudio/uni-ui/lib/uni-col/uni-col.vue"]]);
  const _sfc_main$9 = {
    __name: "Map",
    setup(__props) {
      ...
      const onChange = (e2) => {
        formatAppLog("log", "at pages/Map.vue:100", "Selected value: ", e2.detail.value);
      };
      let map = null;
      vue.onMounted(() => {
        ...
        AMapLoader.load({
          ...
          map = new AMap.Map("mymap", {
            ...
            // 设置倾斜角度，范围是0（无倾斜）到60
            rotation: 0,
            // 设置旋转角度，0表示北方在上，90表示地图顺时针旋转90度
            rotateEnable: true,
            //是否开启地图旋转交互 鼠标右键 + 鼠标画圈移动 或 键盘Ctrl + 鼠标左键画圈移动
            pitchEnable: true,
            //是否开启地图倾斜交互 鼠标右键 + 鼠标上下移动或键盘Ctrl + 鼠标左键上下移动
            features: ["bg", "road"]
            // 显示背景、道路和建筑物，但不显示地名
          });
          ...
          const imageLayer = new AMap.ImageLayer({
            ...
            bounds: new AMap.Bounds(
              ...
              // 左下角坐标  经度：左右（越大越右） 纬度：上下（越大越上）
              [113.396039, 22.532817]
              // 右上角坐标  
            ),
            opacity: 1
            // 设置透明度为0.5，范围是0（完全透明）到1（完全不透明）
          });
          map.add(imageLayer);
          map = new AMap.Map("mymap2", {
            // 设置地图容器id
            viewMode: "2D",
            // 是否为3D地图模式
            zoom: 16,
          ...
          formatAppLog("log", "at pages/Map.vue:166", e2);
        });
      });
      vue.onUnmounted(() => {
      ...
      const chooseImage = () => {
        uni.chooseImage({
          ...
          success: (res) => {
            ...
            formatAppLog("log", "at pages/Map.vue:186", "图片选择成功:", res.tempFilePaths);
          },
          fail: (err) => {
            formatAppLog("error", "at pages/Map.vue:189", "图片选择失败:", err);
          },
          complete: () => {
            formatAppLog("log", "at pages/Map.vue:192", "图片选择操作完成");
          }
        });
      };
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          vue.createElementVNode("view", { class: "layout" }, [
            vue.createVNode(UniSection, {
              title: "寻猫日迹",
              subTitle: "通过基础的 1/24 分栏任意扩展组合形成较为复杂的混合布局",
              type: "line"
            }, {
              default: vue.withCtx(() => [
                vue.createElementVNode("view", { class: "t9h89ho" }, [
                  vue.createCommentVNode(" 第一行 "),
                  vue.createVNode(uniRow, {
                    class: "r89yu",
                    gutter: 0,
                    width: 730
                  }, {
                    default: vue.withCtx(() => [
                      vue.createVNode(uniCol, { span: 7 }, {
                        default: vue.withCtx(() => [
                          vue.createElementVNode("view", { class: "t89hfws" }, [
                            vue.createElementVNode("text", { class: "t7uj9" }, "选择区域：")
                          ])
                        ]),
                        _: 1
                        /* STABLE */
                      }),
                      vue.createVNode(uniCol, { span: 9 }, {
                        default: vue.withCtx(() => [
                          vue.createCommentVNode(" //选择器 "),
                          vue.createElementVNode("view", { class: "t8hj0i" }, [
                            vue.createVNode(vue.unref(UniDataPicker), {
                      ...
                      vue.createVNode(uniCol, { span: 8 }, {
                        default: vue.withCtx(() => [
                          vue.createElementVNode("view", { class: "t98h9uh" }, [
                            vue.createCommentVNode(' <text class="t98h9">常居地：xxx</text> '),
                            vue.createElementVNode("button", {
                              class: "b9yh",
                              onClick: chooseImage
                            }, "选择图片")
                  ...
                  vue.createVNode(uniRow, {
                    ...
                    default: vue.withCtx(() => [
                      vue.createVNode(uniCol, { span: 7 }, {
                        default: vue.withCtx(() => [
                          vue.createElementVNode("view", { class: "t89hfws" }, [
                            vue.createElementVNode("text", { class: "t7uj9" }, "选择小猫：")
                          ])
                        ]),
                        _: 1
                        /* STABLE */
                      ...
                      vue.createVNode(uniCol, { span: 8 }, {
                        default: vue.withCtx(() => [
                          vue.createElementVNode("view", { class: "t98h9uh" }, [
                            vue.createElementVNode("text", { class: "t98h9" }, "常居地：xxx")
                          ])
                        ]),
                        _: 1
                        /* STABLE */
            ...
            vue.createCommentVNode(' <view class="t7gh9h">\r\n				<view class="t89hfws">\r\n					<text class="t7uj9">选择区域：</text>\r\n				</view>\r\n				\r\n				<view class="t8hj0i">\r\n					<uni-data-picker \r\n					      :localdata="dataList"\r\n					      v-model="selectedValue"\r\n					      @change="onChange"\r\n					    />\r\n				</view>\r\n			</view> '),
            vue.createCommentVNode(" 地图1 "),
            vue.createCommentVNode(' <div class="m23rhj" id="mymap"></div> \r\n			<view class="t9gh9hu">\r\n				<image class="i69yhu9" src="../static/mapLogo.png" mode=""></image>\r\n			</view> '),
            vue.createCommentVNode(" 地图2 "),
            vue.createCommentVNode(' <div class="m23rh0" id="mymap2"></div> ')
          ])
        ]);
      };
    }
  };
  const PagesMap = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-61f95d0c"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/pages/Map.vue"]]);
  const _sfc_main$8 = {};
  function _sfc_render$5(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createElementVNode("view", { class: "layout" }, " 111 ")
    ]);
  }
  const PagesMy = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$5], ["__scopeId", "data-v-0776b79a"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/pages/My.vue"]]);
  const _imports_0$1 = "/static/返回.png";
  ...
  const uniSearchBar = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$4], ["__scopeId", "data-v-a149a6be"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/node_modules/@dcloudio/uni-ui/lib/uni-search-bar/uni-search-bar.vue"]]);
  const _sfc_main$6 = {
    name: "uniList",
    "mp-weixin": {
      options: {
  ...
  const UniList = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$3], ["__scopeId", "data-v-cc89e7d4"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/node_modules/@dcloudio/uni-ui/lib/uni-list/uni-list.vue"]]);
  const _sfc_main$5 = {
    __name: "Search",
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "contianer" }, [
          vue.createElementVNode("view", { class: "layout" }, [
            vue.createElementVNode("view", { class: "box-top" }, [
              vue.createElementVNode("view", {
                class: "back",
              ...
              vue.createElementVNode("view", { class: "search-text" }, [
                vue.createVNode(uniSearchBar, { placeholder: "搜索..." })
              ])
            ]),
            vue.createVNode(UniSection, {
              class: "box-contenx",
                ...
                (vue.openBlock(), vue.createElementBlock(
                  ...
                  vue.renderList(10, (item, index) => {
                    return vue.createVNode(
                      ...
                      {
                        default: vue.withCtx(() => [
                          vue.createVNode(UniListItem, { title: "列表文字" })
                        ]),
                        _: 2
                        /* DYNAMIC */
                      },
  ...
  const PagesSearch = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-0c890518"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/pages/Search.vue"]]);
  const _imports_0 = "/static/返回 (1).png";
  const _sfc_main$4 = {
    __name: "Post",
    setup(__props) {
      ...
      function handlerClickBack() {
        ...
        if (pages2.length > 1) {
          ...
          formatAppLog("log", "at pages/Post.vue:107", "没有上一页");
        }
      }
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
          vue.createElementVNode("view", { class: "layout" }, [
            vue.createCommentVNode(" 固定头部 "),
            vue.createElementVNode("view", { class: "box-head" }, [
              vue.createElementVNode("view", { class: "left1" }, [
                ...
                vue.createElementVNode("view", { class: "text001" }, " 发现 ")
              ])
            ]),
            vue.createCommentVNode(" 博主相关 "),
            vue.createElementVNode("view", { class: "box-blogger" }, [
              vue.createElementVNode("view", { class: "bb-left" }, [
                vue.createElementVNode("img", {
                  class: "img2",
                  src: _imports_1,
                  alt: ""
                }),
                vue.createElementVNode("text", { class: "text1" }, "dogdoggo")
              ]),
              vue.createElementVNode("view", { class: "bb-right" }, [
                vue.createElementVNode("button", {
                  class: "btn1",
                  plain: "ture"
                }, "关注"),
                vue.createElementVNode("view", { class: "heart" }, [
                  vue.createVNode(uniIcons, {
                    type: "download",
                    size: "26"
                  })
            ...
            vue.createCommentVNode(" 中间滚动内容 "),
            vue.createElementVNode("view", { class: "box-body" }, [
              vue.createCommentVNode(" <view> "),
              vue.createCommentVNode(" 轮播图 "),
              vue.createElementVNode("view", { class: "uni-swiper" }, [
                vue.createElementVNode("swiper", {
                  ...
                  (vue.openBlock(true), vue.createElementBlock(
                    vue.Fragment,
                    null,
                    vue.renderList(images.value, (item) => {
              ...
              vue.createElementVNode("view", { class: "text-content" }, [
                vue.createElementVNode("view", { class: "text" }, " 千万年形成的冰川，百米深的冰缝，色彩斑斓的冰川湖，像不像青藏高原？ "),
                vue.createElementVNode("view", { class: "data" }, " 8月28日 ")
              ]),
              vue.createElementVNode("view", { class: "operate" }, [
                ...
                vue.createElementVNode("view", { class: "chatbubble" }, [
                  vue.createVNode(uniIcons, {
                    type: "chatbubble",
                    size: "30"
                  })
                ]),
                vue.createElementVNode("view", { class: "paperplane" }, [
                  vue.createVNode(uniIcons, {
                    type: "paperplane",
                    size: "28"
                  })
              ...
              vue.createElementVNode("view", { class: "comments" }, " 8,920次赞 "),
              vue.createCommentVNode(" </view> ")
            ]),
            vue.createCommentVNode(" 固定底部 "),
            vue.createCommentVNode(' <view class="box-foot">\r\n				<view class="foot31">\r\n					<text class="text31">底部内容</text>\r\n				</view>\r\n			  \r\n			</view> ')
          ])
        ]);
      };
    }
  };
  const PagesPost = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-89e4b452"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/pages/Post.vue"]]);
  const _sfc_main$3 = {};
  ...
  const PagesCard = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__scopeId", "data-v-cb85926e"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/pages/Card.vue"]]);
  const _sfc_main$2 = {};
  ...
  const PagesModifyCatInfo = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__scopeId", "data-v-c4e97dfc"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/pages/ModifyCatInfo.vue"]]);
  const _sfc_main$1 = {};
  ...
  const PagesSendPost = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-54b8d017"], ["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/pages/SendPost.vue"]]);
  __definePage("pages/Home", PagesHome);
  __definePage("pages/CatClaw", PagesCatClaw);
  __definePage("pages/Map", PagesMap);
  __definePage("pages/My", PagesMy);
  __definePage("pages/Search", PagesSearch);
  __definePage("pages/Post", PagesPost);
  __definePage("pages/Card", PagesCard);
  __definePage("pages/ModifyCatInfo", PagesModifyCatInfo);
  __definePage("pages/SendPost", PagesSendPost);
  const _sfc_main = {
    onLaunch: function() {
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "E:/06-02应用程序区/07-01HBuilderX/HBuilderProjects/PawPrint Diaries/App.vue"]]);
  function createApp() {
